 ...
 */
public class Back2ReleasePnt extends RoboticsAPIApplication
{
	...
	private final static String informationText="Line 2 release point safe?";
    ...
    public void run()
    {
    	...
    	_MultiFunTool.getFrame("/ToolFlange").move(lin(getApplicationData().getFrame("/StarGraspPnt")).setCartVelocity(150.0).setMode(impedanceControlMode));
    ...
    {
        final Back2ReleasePnt app = new Back2ReleasePnt();
        app.runApplication();
    }
